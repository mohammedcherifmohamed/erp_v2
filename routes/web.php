...
Route::get('/bundles/{classe}', [LandingPageController::class, 'bundleDetails'])->name('bundles.details');
...
Route::post('/courses/{classe}/enroll-bundle', [LandingPageController::class, 'enrollBundle'])->middleware('auth')->name('courses.enroll-bundle');
...
Route::get('/section-enrollments/{sectionEnrollment}/success', [LandingPageController::class, 'sectionEnrollmentSuccess'])->middleware('auth')->name('section-enrollments.success');
