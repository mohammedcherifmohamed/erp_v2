...
@section('page-subtitle', 'Add a new academic grade')
            ...
            <form method="POST" action="{{ route('admin.grades.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required class="input @error('name') input-error @enderror" placeholder="e.g., Grade 1">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="code" type="text" name="code" value="{{ old('code') }}" required class="input @error('code') input-error @enderror" placeholder="e.g., G1">
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    <button type="submit" class="btn-primary">Create Grade</button>
                </div>
            </form>
        </div>
    </div>
