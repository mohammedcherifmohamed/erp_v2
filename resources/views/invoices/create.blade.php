...
@section('page-subtitle', 'Generate a new invoice')
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.invoices.store') }}" class="space-y-6">
                ...
                <div>
                    <label for="total_amount" class="label">Total Amount (MAD)</label>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" class="input" placeholder="Invoice description">{{ old('description') }}</textarea>
                </div>
