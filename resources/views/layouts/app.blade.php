...
<body class="min-h-screen bg-gray-50">
    <div class="flex h-screen overflow-hidden">
        {{-- Sidebar --}}
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 lg:static lg:translate-x-0 -translate-x-full transition-transform duration-200 ease-in-out flex flex-col">
            <div class="flex items-center h-16 px-6 border-b border-gray-200 flex-shrink-0">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Plateforme éducative</p>
                    </div>
                </div>
            </div>
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto scrollbar-thin min-h-0">
