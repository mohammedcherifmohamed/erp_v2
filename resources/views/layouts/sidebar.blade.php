...
@if($role === 'admin')
    <div class="mb-2 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Main</div>
    ...
    <div class="mt-6 mb-2 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Academic</div>
    ...
    <div class="mt-6 mb-2 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">People</div>
    ...
    <div class="mt-6 mb-2 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Enrollment</div>
    ...
    <div class="mt-6 mb-2 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Attendance</div>
...
@elseif($role === 'teacher')
    ...
    <div class="mt-6 mb-2 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Teaching</div>
...
@elseif($role === 'student')
    ...
    <div class="mt-6 mb-2 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Learning</div>
...
@elseif($role === 'parent')
    ...
    <div class="mt-6 mb-2 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Children</div>
