...
@section('page-subtitle', 'Overview of your educational institution')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="card">
            <div class="card-header flex items-center justify-between">
                <h3 class="font-semibold text-gray-900">Recent Enrollments</h3>
                <a href="{{ route('admin.enrollments.index') }}" class="text-sm text-primary-600 hover:text-primary-700">View all</a>
            </div>
                ...
                <div class="table-container">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center text-gray-500 py-8">No enrollments yet</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="divide-y divide-gray-100">
                    @forelse($announcements as $announcement)
                        <div class="p-4 hover:bg-gray-50 transition-colors">
                            ...
                            <p class="text-xs text-gray-400 mt-2">By {{ $announcement->author->full_name }} &middot; {{ $announcement->created_at->diffForHumans() }}</p>
                        </div>
                    @empty
