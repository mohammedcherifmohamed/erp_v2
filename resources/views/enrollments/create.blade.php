...
@section('page-subtitle', 'Enroll a student in a class')
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.enrollments.store') }}" class="space-y-6">
                @csrf
                <div>
                    <label for="student_id" class="label">Student <span class="text-danger-500">*</span></label>
                ...
                <div class="flex items-center justify-end gap-3">
                    <a href="{{ route('admin.enrollments.index') }}" class="btn-outline">Cancel</a>
