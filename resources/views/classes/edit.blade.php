    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.classes.update', $classe) }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="image" class="label">Class Image</label>
                    ...
                    <div>
                        <label class="inline-flex items-center gap-2">
                            ...
                            <span class="text-sm text-gray-700">Public class</span>
                        </label>
                    </div>
                </div>
                <div>
                    ...
                    <select id="is_active" name="is_active" class="input">
                        <option value="1" {{ old('is_active', $classe->is_active) ? 'selected' : '' }}>Active</option>
                        <option value="0" {{ old('is_active', $classe->is_active) ? '' : 'selected' }}>Inactive</option>
                    </select>
                </div>
