...
@section('page-subtitle', 'Add a new course')
            ...
            <form method="POST" action="{{ route('admin.courses.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required class="input @error('name') input-error @enderror" placeholder="e.g., Mathematics">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="code" type="text" name="code" value="{{ old('code') }}" required class="input @error('code') input-error @enderror" placeholder="e.g., MATH101">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input id="credits" type="number" step="0.5" name="credits" value="{{ old('credits', 0) }}" class="input" min="0">
                    </div>
                </div>
                <div>
                    <label for="description" class="label">Description</label>
                    <textarea id="description" name="description" rows="3" class="input @error('description') input-error @enderror" placeholder="Course description">{{ old('description') }}</textarea>
                </div>
