...
@section('page-subtitle', 'Inscrire un nouvel enseignant')
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.teachers.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="hourly_rate" class="label">Taux horaire</label>
                ...
                <div>
                    ...
                    <input id="specialization" type="text" name="specialization" value="{{ old('specialization') }}" class="input" placeholder="Ex. : Mathématiques">
                </div>
                <div>
                    <label for="bio" class="label">Biographie</label>
                    <textarea id="bio" name="bio" rows="3" class="input @error('bio') input-error @enderror" placeholder="Brève biographie">{{ old('bio') }}</textarea>
                </div>
